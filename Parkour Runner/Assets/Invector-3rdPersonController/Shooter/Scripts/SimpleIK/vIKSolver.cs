...
namespace Shooter.Scripts.SimpleIK
{
    ...
    public class vIKSolver
    {
        ...
        public vIKSolver(Transform rootBone, Transform middleBone, Transform endBone)
        {
        ...
        public virtual void SetIKPosition(Vector3 ikPosition)
        {
	        ...
	        if (hintPosition != Vector3.zero) // if middleBoneGoal is null, the direction will be calculated with forearm's point
