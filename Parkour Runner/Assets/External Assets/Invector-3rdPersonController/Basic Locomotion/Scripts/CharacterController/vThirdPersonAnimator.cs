    ...
    public abstract class vThirdPersonAnimator : vThirdPersonMotor
    {
        ...
        {            
            ...
            else
            {
                ...
                dir.z *= speed;               
                animator.SetFloat("InputVertical", !stopMove && !lockMovement ? dir.z : 0f, 0.25f, Time.deltaTime);
                animator.SetFloat("InputHorizontal", !stopMove && !lockMovement ? dir.x : 0f, 0.25f, Time.deltaTime);
            }           
