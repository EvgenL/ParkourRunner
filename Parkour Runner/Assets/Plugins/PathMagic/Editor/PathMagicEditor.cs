		...
		public override void OnInspectorGUI ()
		{
			...
			if (utilityFoldout) {
				...
				if (serializedObject.isEditingMultipleObjects) {
					...
					if (GUILayout.Button (new GUIContent ("Look to center", "Updates all waypoints to look at the center of the path"), GUILayout.Width ((EditorGUIUtility.currentViewWidth - 60f) / 2f))) {
			...
			EditorGUILayout.Separator ();
			EditorGUILayout.LabelField ("CTRL/CMD + Click", "Append new waypoint at mouse position\t");
